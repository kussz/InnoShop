...
namespace InnoShop.Domain.Migrations
{
    ...
    [Migration("20241122072208_NamesUnique")]
    partial class NamesUnique
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InnoShop.Domain.Models.Locality", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name" }, "UQ__Localiti__5E55825B2B853D4G")
                        .IsUnique();
            ...
            modelBuilder.Entity("InnoShop.Domain.Models.ProdType", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name" }, "UQ__ProdType__5E55825B2B853D4K")
                        .IsUnique();
